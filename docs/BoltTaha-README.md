...
**AI & Software Engineer · BoltTaha**

I build AI applications, backend services, and data workflows with Python, JavaScript, and language-model APIs. My projects explore database analysis, document processing, conversation memory, and practical application interfaces.

[Portfolio](https://muhammadtaha.app) · [LinkedIn](https://www.linkedin.com/in/bolttaha/) · [Email](mailto:contact@muhammadtaha.app)
...
BS Computer Science student at FAST-NUCES, expected class of 2027. Co-lead for Development & Projects at the AWS Cloud Club, FAST-NUCES Peshawar. My professional work history includes AI and automation work at Gohar Textile Mills and freelance software/data projects.

Public repositories show the implementation and contribution history. Client-work summaries are kept separate from personal and educational projects on the portfolio. I avoid publishing confidential implementations or treating repository ownership as proof of sole authorship.

## Get in touch

For a software engineering role or project, email [contact@muhammadtaha.app](mailto:contact@muhammadtaha.app) with the problem and useful context. Find project explanations and professional links at [muhammadtaha.app](https://muhammadtaha.app).
